...
from sdd.schemas import FilteredIssuesResult, SemanticCheckResult, EvidencePack
from sdd.utils import TEMPORAL_MARKERS, TOOL_TYPE_ALLOWLIST, extract_evidence_based_issues
    ...
    def semantic_check(self, artigo: str, ferramentas: str, tool_type: str = "unknown") -> list[str]:
        ...
        try:
            ...
            if "SEM PROBLEMAS" in text.upper():
                return []
            return extract_evidence_based_issues(text, article_window)
